...
--
-- Host: 127.0.0.1    Database: eisenhower
-- ------------------------------------------------------
...
CREATE TABLE `tasks` (
  ...
  PRIMARY KEY (`id`),
  KEY `tasks_users_id_fk` (`id_user`),
  CONSTRAINT `tasks_users_id_fk` FOREIGN KEY (`id_user`) REFERENCES `users` (`id`)
...
CREATE TABLE `tasks_history` (
  ...
  PRIMARY KEY (`id`),
  KEY `tasks_history_users_id_fk` (`id_user`),
  CONSTRAINT `tasks_history_users_id_fk` FOREIGN KEY (`id_user`) REFERENCES `users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-12-17 10:52:57
